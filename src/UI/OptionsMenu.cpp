...
OptionsMenu::OptionsMenu(SDL_Renderer *rend, Game *g)
    : Menu("OptionsMenu"),
      renderer(rend),
      game(g),
...
void OptionsMenu::CalculeButtonsRects()
{
    buttonRects.clear();
    int Y = 180 + posY;
    int spacing = 60;
...
bool OptionsMenu::handleInput(SDL_Event &event)
{
...
void OptionsMenu::render(SDL_Renderer *rend)
{
